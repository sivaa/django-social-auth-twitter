...
DATABASES = {
    'default': {
        ...
        'NAME': 'dsa_tw',                      # Or path to database file if using sqlite3.
...
TWITTER_CONSUMER_KEY    =   'mGldVYHa2KVfZAxKIxZKAw'
TWITTER_CONSUMER_SECRET =   'Gd8ngyFQ2aS53YR9c3lPL1gejoIuz9a5xYEpluc'
